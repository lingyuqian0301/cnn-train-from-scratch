    ...
    if config_path.exists():
        try:
            with open(config_path, "r") as f:
                cfg = json.load(f)
            model_path = cfg.get("model_path", "waste_classifier_best.pth")
        except Exception:
            model_path = "waste_classifier_best.pth"
    else:
        model_path = "waste_classifier_best.pth" if Path("waste_classifier_best.pth").exists() else "saved_models/best_model.pth"
