...
class SortingSimulator:
    ...
    def __init__(self, max_bin_capacity: int = 100, log_file: str = "logs/sorting_log.json"):
        ...
        self.waste_to_bin = {
            ...
            'plastic': BinLocation.BIN_A,
            'paper': BinLocation.BIN_A,
            'cardboard': BinLocation.BIN_A,
            'biological': BinLocation.BIN_C,
            'battery': BinLocation.BIN_B,  # Hazardous
            'trash': BinLocation.BIN_E,
            'clothes': BinLocation.BIN_D,
            'shoes': BinLocation.BIN_D,
        }
